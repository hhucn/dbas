...
RUN python setup.py --quiet develop \
    ...
    && bash -c 'google-closure-compiler-js --createSourceMap --compilationLevel SIMPLE ./dbas/static/js/libs/moment-2.18.1.js > dbas/static/js/libs/moment-2.18.1.min.js' \
