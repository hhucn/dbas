...
user_colleagues = ['ansel101', 'mamau002', 'chmet101', 'jurom100', 'tokra100', 'luhim001', 'toamf100', 'daneu102', 'hisch100', 'rabio100', 'alsch132']
...
def evaluate_graph():
    ...
    for t in sorted_max[-top_count:]:
        print('    - Position {} with {} nodes'.format(t[0], t[1]))
    print('\n')
