...
class InputValidatorTests(unittest.TestCase):
    ...
    def test_check_for_integer(self):
        ...
        # conditions_response
        ignore_empty_case_len_zero_true = reaction.is_integer(variable='',
                                                              ignore_empty_case=True)
        self.assertEqual(ignore_empty_case_len_zero_true, True)

        long_string_false = reaction.is_integer(variable=',' * 1000 + '30' + '?' * 1000,
                                                ignore_empty_case=True)
        self.assertEqual(long_string_false, False)

        ignore_empty_case_len_false = reaction.is_integer(variable='str',
                                                          ignore_empty_case=True)
        self.assertEqual(ignore_empty_case_len_false, False)

        not_ignore_empty_case_len_zero_false = reaction.is_integer(variable='',
                                                                   ignore_empty_case=False)
        self.assertEqual(not_ignore_empty_case_len_zero_false, False)

        not_ignore_empty_case_len_false = reaction.is_integer(variable='str',
                                                              ignore_empty_case=False)
        self.assertEqual(not_ignore_empty_case_len_false, False)

        ignore_empty_case_int_true = reaction.is_integer(variable=123,
                                                         ignore_empty_case=True)
        self.assertEqual(ignore_empty_case_int_true, True)

        not_ignore_empty_case_int_true = reaction.is_integer(variable=1,
                                                             ignore_empty_case=False)
        self.assertEqual(not_ignore_empty_case_int_true, True)

        input_none_false = reaction.is_integer(variable=None,
                                               ignore_empty_case=True)
        self.assertEqual(input_none_false, False)

        input_array_false = reaction.is_integer(variable=[1, 2, 3, 'str'],
                                                ignore_empty_case=True)
