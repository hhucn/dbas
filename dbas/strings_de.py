...
class GermanDict:
	...
	def set_up_de_dict(_self):
		...
		de_lang[_self.undermine1] = 'Es ist falsch, dass'
		de_lang[_self.undermine2] = ''
		de_lang[_self.support1] = 'Es ist richtig, dass'
		de_lang[_self.support2] = ''
		...
		de_lang[_self.butIDoNotBelieveCounterFor] = 'aber ich glaube nicht, dass es ein gutes Gegenargument dafür ist, dass'
		...
		de_lang[_self.discussionEndLinkText] = 'Sie können <a id="discussionEndStepBack" href="#">hier</a> klicken, um einen Schritt zurück zugehen oder den oberen Button bzw. <a href="" id="discussionEndRestart">diesen Link</a> nutzen, um die Diskussion neu zustarten.'
		...
		de_lang[_self.doesNotHold] = 'keine gute Idee ist'
		de_lang[_self.doesNotHoldBecause] = 'nicht gilt, weil'
		...
		de_lang[_self.howeverIHaveMuchStrongerArgumentRejecting] = 'Jedoch habe ich ein viel stärkeres Argument zum Ablehnen von'
		de_lang[_self.howeverIHaveEvenStrongerArgumentRejecting] = 'Jedoch habe ich ein stärkeres Argument zum Ablehnen von'
		de_lang[_self.howeverIHaveMuchStrongerArgumentAccepting] = 'Jedoch habe ich ein viel stärkeres Argument zum Akzeptieren von'
		de_lang[_self.howeverIHaveEvenStrongerArgumentAccepting] = 'Jedoch habe ich ein stärkeres Argument zum Akzeptieren von'
		...
		de_lang[_self.isFalse] = 'falsch ist'
		...
		de_lang[_self.holds] = 'richtig ist'
		...
		de_lang[_self.notInsertedErrorBecauseEmpty] = 'Ihre Idee wurde nicht gespeichert, da das Feld leer ist.'
		...
		de_lang[_self.theySay] = 'Sie sagen'
		de_lang[_self.theyThink] = 'Sie denken'
		...
		de_lang[_self.userPasswordNotMatch] = 'Benutzername und / oder Passwort sind falsch'
