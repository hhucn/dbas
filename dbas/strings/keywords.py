...
class Keywords(Enum):
    ...
    accountWasAdded = 'Your account XXX was added and you are now able to log in.'
    accountRegistration = 'D-BAS Account Registration'
    accountWasRegistered = 'Your account XXX was successfully registered for this e-mail.'
