...
class Keywords(Enum):
    ...
    otherUsersClaimStrongerArgumentS = 'claims to have a stronger statement to XXX'
    otherUsersClaimStrongerArgumentP = 'Other participants claim to have a stronger statement to XXX'
