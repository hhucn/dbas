...
class Keywords(Enum):
    ...
    alreadyEditedByYou = 'You have already sent an edit for this!'
    alreadyEditedByYouAndOthers = 'We could just accept just some of the proposals, because you and other participants already have sent an edits for this!'
    alreadyEditedByOthers = 'Other participants already have sent an edit for this!'
    ...
    voteCountTextFirstM = 'You are the first one with this opinion '
    voteCountTextFirstF = 'You are the first one with this opinion  '
    voteCountTextMayBeFirst = 'You would be the first one with this opinion'
    voteCountTextMayBeFirstM = 'You would be the first one with this opinion '
    voteCountTextMayBeFirstF = 'You would be the first one with this opinion'
    voteCountTextOneOther = 'One other participant with this opinion'
    voteCountTextOneOtherM = 'One other participant with this opinion '
    voteCountTextOneOtherF = 'One other participant with this opinion  '
    voteCountTextMore = 'more participants with this opinion'
    voteCountTextOneMore = ' participant with this opinion'
    voteCountTextOneMoreM = ' participant with this opinion '
    voteCountTextOneMoreF = ' participant with this opinion  '
