...
class Keywords(Enum):
    ...
    accoutErrorTryLateOrContant = 'Your account with the nick could not be added. Please try again or contact the author.'
    ...
    butIDoNotBelieveReasonForReject = 'but I do not believe that this is a reason for rejecting'
    ...
    feelFreeToLogin = 'If you want to proceed, please feel free to <u><a  data-href="login" data-toggle="modal" data-target="#popup-login" title="Login">login</a></u> yourself :)'
    forText = 'for'
    forThat = 'accepting that'
    ...
    hold = 'hold'
    howeverIHaveMuchStrongerArgumentRejectingThat = 'However, I have a much stronger argument for rejecting that'
    howeverIHaveMuchStrongerArgumentAcceptingThat = 'However, I have a much stronger argument for accepting that'
    howeverIHaveMuchStrongerArgument = 'However, I have a much stronger argument for'
    howeverIHaveEvenStrongerArgumentRejecting = 'However, I have an even stronger argument for rejecting that'
    howeverIHaveEvenStrongerArgumentAccepting = 'However, I have an even stronger argument for accepting that'
    imprint = 'Imprint'
    ...
    iHaveEvenStrongerArgumentRejecting = 'I have an even stronger argument for rejecting that'
    iHaveMuchStrongerArgumentAccepting = 'I have a much stronger argument for accepting that'
    iHaveEvenStrongerArgumentAccepting = 'I have an even stronger argument for accepting that'
    iNoOpinion = 'I have no opinion regarding'
    interestingOnDBAS = 'Interesting discussion on DBAS'
    inputEmpty = 'Input is empty!'
    informationForStatements = 'Information for the statements'
    jumpAnswer0 = 'Right, I support the XXCONCLUSIONXX and accept the XXPREMISEXX.'
    ...
    otherUsersClaimStrongerArgumentRejecting = 'Other participants claim to have a stronger statement for rejecting'
    otherUsersClaimStrongerArgumentAccepting = 'Other participants claim to have a stronger statement for accepting'
    ...
    strength = 'Strength'
    strong = 'strong'
    strongerStatementForAccepting1 = 'but they claim to have a stronger statement for '
    strongerStatementForAccepting2 = 'accepting'
    strongerStatementForAccepting3 = ''
    strongerStatementForRecjecting1 = 'but they claim to have a stronger statement for '
    strongerStatementForRecjecting2 = 'rejecting'
    strongerStatementForRecjecting3 = ''
    ...
    visitEditQueueLimitation = 'You need at least XX reputation points to review edits.'
    visitOptimizationQueue = 'Visit the optimization queue of D-BAS.'
    visitOptimizationQueueLimitation = 'You need at least XX reputation points to review optimizations.'
    visitHistoryQueue = 'Visit the history of reviews of D-BAS.'
    visitHistoryQueueLimitation = 'You need at least XX reputation points to have a look into the past.'
    ...
    youHaveMuchStrongerArgumentForAccepting = 'You have a much stronger argument for accepting'
    youHaveMuchStrongerArgumentForRejecting = 'You have a much stronger argument for rejecting'
