...
def get_all_statements_matching(query_string: str) -> dict:
    """
    This function returns all similar statements and the corresponding information for a given search term.
    ...
    This function tests with each request whether the host (search) is reachable.
