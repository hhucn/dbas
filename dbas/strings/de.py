...
de_lang = {
    ...
    _.firstPositionTextM: 'Sie sind der Erste in dieser Diskussion, sodass es noch keine Vorschläge gibt!',
    _.firstPositionTextF: 'Sie sind der Erste in dieser Diskussion, sodass es noch keine Vorschläge gibt!',
    _.firstPositionText: 'Sie sind der/die Erste in dieser Diskussion, sodass es noch keine Vorschläge gibt!',
    ...
    _.reaction_text_support: 'Ich halte {} für richtig und finde sie gut begründet.',
    ...
    _.strongerStatementForP: 'aber die Teilnehmer haben eine stärkere Aussage zur',
    _.accepting: 'Annahme',
