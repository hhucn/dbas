...
de_lang = {
    ...
    _.discussionEndLinkTextLoggedIn: 'Sie können oben den Button nutzen, um die Diskussion zu wiederholen.',
    _.discussionEndLinkTextNotLoggedIn: 'Sie können oben den Button nutzen, um die Diskussion zu wiederholen.',
    ...
    _.ldapInfo: 'Wir benutzen das Personenverzeichnug der Uni Düsseldorf. Alle Daten und Informationen werden natürlich SSL-verschlüsselt gesendet und nach Erhalt unter keinen Umständen an Dritte weitergegeben.',
    _.more: 'Mehr',
    _.medium: 'mittel',
