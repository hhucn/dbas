...
de_lang = {
    ...
    _.displayControlDialogGuidedBody: 'Du wirst nie etwas wie eine Argumentationskarte sehen, da das System dich führt. Somit ist das System dynamisch und generisch für dich',
    ...
    _.discussionInfoTooltipSg: 'Die Diskussion wurde am {} um {} Uhr gestartet und hat nur {} Argument. Komm\' und machen Sie mit',
    ...
    _.exampleAddTopicDescription: 'z.B.: In den letzten Tagen diskutiert Ihre Famile über den neuen Zuwachs bei den Haustieren. Zur Auswahl sind Hund und Katzen gekommen. Nun zählt Ihre Meinung',
