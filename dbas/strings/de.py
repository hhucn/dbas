...
de_lang = {
    ...
    _.priv_access_optimization_queue: 'Zugriff auf die Optimierungs-Queue',
    _.priv_access_delete_queue: 'Zugriff auf die Löschantrags-Queue',
    _.priv_access_duplicate_queue: 'Zugriff auf die Duplikats-Queue',
    _.priv_access_edit_queue: 'Zugriff auf die Editierungs-Queue',
    _.priv_access_split_queue: 'Zugriff auf die Teilungs-Queue',
