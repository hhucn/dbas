...
de_lang = {
    ...
    _.discussionEndLinkTextNotLoggedIn: 'Sie können oben den Button nutzen, um die Diskussion zu neu zu starten.',
    _.discussionEndLinkTextWithQueueLoggedIn: 'Suchen Sie nach weiteren Aufgaben? Schauen Sie doch einmal in unsere <a id="discussionEndReview">Prüfsektion</a>. Alternativ können Sie oben den Button nutzen um die Diskussion zu wiederholen.',
    _.discussionEndLinkTextWithQueueNotLoggedIn: 'Suchen Sie nach weiteren Aufgaben? <a  data-href="login" data-toggle="modal" data-target="#popup-login" title="Login">Login</a> und schauen Sie doch einmal in unsere <a id="discussionEndReview">Prüfsektion</a>. Alternativ können Sie den oben den Button nutzen um die Diskussion zu wiederholen.',
