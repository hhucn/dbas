...
de_lang = {
    ...
    _.discussionEndLinkTextLoggedIn: 'Sie können unten links den Button nutzen, um die Diskussion zu neu zu starten.',
    _.discussionEndLinkTextNotLoggedIn: 'Sie können unten links den Button nutzen, um die Diskussion zu neu zu starten.',
    _.discussionEndLinkTextWithQueueLoggedIn: 'Suchen Sie nach weiteren Aufgaben? Schauen Sie doch einmal in unsere <a id="discussionEndReview">Prüfsektion</a>. Alternativ können Sie unten links den Button nutzen um die Diskussion zu wiederholen.',
