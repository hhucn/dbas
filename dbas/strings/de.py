...
class GermanDict:
    ...
    def set_up(_self):
        ...
        de_lang[_self.argumentFlaggedBecauseOfftopic] = 'Dieses Argument wurde von einer/m Benutzer/in gemeldet, da es möglicherweise nicht themenbezogen ist.'
        de_lang[_self.argumentFlaggedBecauseSpam] = 'Dieses Argument wurde von einer/m Benutzer/in gemeldet, da es möglicherweise Spam ist.'
        de_lang[_self.argumentFlaggedBecauseHarmful] = 'Dieses Argument wurde von einer/m Benutzer/in gemeldet, da es möglicherweise nicht angebracht, schädlich oder missbräuchlich ist.'
        de_lang[_self.argumentFlaggedBecauseOptimization] = 'Dieses Argument wurde von einer/m Benutzer/in gemeldet, da es möglicherweise sprachlicher Korrektur bedarf.'
        ...
        de_lang[_self.jumpAnswer0] = 'Ja, ich halte die XXCONCLUSIONXX für richtig und finde die XXPREMISEXX gut.<div class="text-muted">[Konfrontiere mit zufälligem Argument]</div>'
        ...
        de_lang[_self.jumpAnswer3] = 'Nein, ich halte die XXCONCLUSIONXX für falsch.<div class="text-muted">[Begründen, warum man sie falsch findet]</div>'
