...
de_lang = {
    ...
    _.pwdShort: 'Passwort ist zu kurz (min. 6 Zeichen)',
    ...
    _.emailSentGeneric: 'Wir senden Ihnen nun eine E-Mail mit Instruktionen um Ihr Passwort zurückzusetzen',
    _.emailPasswordRequestNoUser: 'Wir konnten Ihre Adresse in unseren System nicht finden. Kontrollieren Sie bitte Ihre Eingabe',
