...
de_lang = {
    ...
    _.mergeMultipleStatementsWhichFlag: 'Bitte wählen Sie die Aussgen, die zusammengehangen werden sollen.',
    _.splitStatement: 'Trennung von Aussagen!',
    _.splitMultipleStatementsWhichFlag: 'Bitte geben Sie die getrennte Version der Aussage ein; Pro Feld eine Aussage.',
