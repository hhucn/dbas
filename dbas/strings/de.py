...
de_lang = {
    ...
    _.priv_access_optimization_queue: 'Zugriff auf die Optimierungs-QueueAdapter',
    _.priv_access_delete_queue: 'Zugriff auf die Löschantrags-QueueAdapter',
    _.priv_access_duplicate_queue: 'Zugriff auf die Duplikats-QueueAdapter',
    _.priv_access_edit_queue: 'Zugriff auf die Editierungs-QueueAdapter',
    _.priv_access_split_queue: 'Zugriff auf die Teilungs-QueueAdapter',
    _.priv_access_merge_queue: 'Zugriff auf die Zusammenführungs-QueueAdapter',
