...
de_lang = {
    ...
    _.mergeStatement: 'Zusammenführen von Aussagen!',
    _.mergeMultipleStatements: 'Bitte wählen Sie die Aussgen, die zusammengehangen werden sollen.',
    _.mergeMultiplePGroup: 'Die von Ihnen gewählte Aussage besteht schon aus mehr als einer Aussage. Unten finden Sie die einzelnen Bestandteile. Möchten Sie dennoch weitermachen?',
    _.splitStatement: 'Trennung von Aussagen!',
    _.splitMultipleStatements: 'Bitte geben Sie die getrennte Version der Aussage ein; Pro Feld eine Aussage.',
    _.splitMultiplePGroup: 'Die von Ihnen gewählte Aussage ist an sich schon, wie unten angegeben, getrennt. Möchten Sie dennoch eine neue Trennung angeben?',
