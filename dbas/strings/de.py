...
de_lang = {
    ...
    _.discussionEndLinkText: 'Suchen Sie nach weiteren Aufgaben? Schauen Sie doch einmal in unsere <a id="discussionEndReview">Prüfsektion</a>. Alternativ können Sie den oberen Button bzw. <a id="discussionEndRestart" data-href="restart">diesen Link</a> nutzen, um die Diskussion neu zustarten.',
