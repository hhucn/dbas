...
class DictionaryHelper(object):
    ...
    def add_button_text(self, return_dict):
        ...
        return_dict['buttons'].update({'report': _tn_dis.get(_tn_dis.report),
                                       ...
                                       'show_supports_on_my_statements': _tn_dis.get(_tn_dis.showSupportsOnMyStatements),
                                       'hide_supports_on_my_statements': _tn_dis.get(_tn_dis.hideSupportsOnMyStatements),
                                       'show_attacks_on_my_statements': _tn_dis.get(_tn_dis.showAttacksOnMyStatements),
                                       'hide_attacks_on_my_statements': _tn_dis.get(_tn_dis.hideAttacksOnMyStatements),
