...
class Translator(object):
	...
	def set_up_en_dict(self):
		...
		en_lang[self.decisionIndex7] = 'Decision Index - Last 7 Days'
		en_lang[self.decisionIndex30] = 'Decision Index - Last 30 Days'
		en_lang[self.decisionIndex7Info] = 'Count of made decision (due to clicks in a discussion) in the last 7 days'
		en_lang[self.decisionIndex30Info] = 'Count of made decision (due to clicks in a discussion) in the last 30 days'
		...
		en_lang[self.discussionInfoTooltip1] = 'The discussion was started'
		...
		en_lang[self.editIndex] = 'Edit Index - Last 30 Tage'
		en_lang[self.editIndexInfo] = 'Count of Edits'
		...
		en_lang[self.empty_notification_input] = 'Notification title or text is empty or too short!'
		...
		en_lang[self.iHaveEvenStrongerArgumentRejecting] = 'I have an even stronger argument for rejecting that'
		...
		en_lang[self.notLoggedIn] = 'You are not logged in.'
		...
		en_lang[self.otherParticipantsDontHaveNewCounterForThat] = 'Other participants do not have any new counter-argument for that. You already have seen all other counter-arguments.'
		...
		en_lang[self.publicNickTitle] = 'Enables/Disables the real nickname on your public page.'
		...
		en_lang[self.recipientNotFound] = 'Recipient not found!'
		...
		en_lang[self.statementIndex] = 'Statement Index - Last 30 Days'
		en_lang[self.statementIndexInfo] = 'Count of added Statements'
		...
		en_lang[self.whatIsYourIdea] = 'What is your idea? What should we do?'
	...
	def set_up_de_dict(self):
		...
		de_lang[self.decisionIndex7] = 'Entscheidungs Index - Letzte 7 Tage'
		de_lang[self.decisionIndex30] = 'Entscheidungs Index - Letzte 30 Tage'
		de_lang[self.decisionIndex7Info] = 'Anzahl an getroffenen Entscheidungen (bedingt durch Klicks im System), in den letzten 7 Tage'
		de_lang[self.decisionIndex30Info] = 'Anzahl an getroffenen Entscheidungen (bedingt durch Klicks im System), in den letzten 30 Tage'
		...
		de_lang[self.displayControlDialogExpertTitle] = 'Experten-Ansicht'
		...
		de_lang[self.discussionInfoTooltip1] = 'Die Diskussion wurde vor'
		de_lang[self.discussionInfoTooltip2] = 'gestartet und hat schon'
		...
		de_lang[self.editIndex] = 'Änderunsg Index - Letzte 30 Tage'
		de_lang[self.editIndexInfo] = 'Anzahl an Änderungen'
		...
		de_lang[self.empty_notification_input] = 'Nachrichten-Titel oder Text ist leer oder zu kurz!'
		...
		de_lang[self.iHaveEvenStrongerArgumentRejecting] = 'Ich habe ein stärkeres Argument zum Ablehnen von'
		...
		de_lang[self.notLoggedIn] = 'Sie sind nicht angemeldet!'
		...
		de_lang[self.otherParticipantsDontHaveNewCounterForThat] = 'Andere Teilnehmer haben kein neues Gegenargument dafür. Sie habe schon alle Gegenargumente gesehen.'
		...
		de_lang[self.publicNickTitle] = '(De-)Aktiviert Ihren richtigen Nickname auf Ihrer öffentlichen Seite'
		...
		de_lang[self.statementIndex] = 'Aussagen Index - Letzte 30 Tage'
		de_lang[self.statementIndexInfo] = 'Anzahl an hinzugefügten Aussagen'
		...
		de_lang[self.whatIsYourIdea] = 'Was ist Ihre Idee? Was sollten wir machen?'
		...
		de_lang[self.youDisagreeWith] = 'Sie wiedersprechen'
