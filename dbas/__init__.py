...
def main(global_config, **settings):
	...
	config.add_route('ajax_set_user_receive_notifications',         'ajax_set_user_receive_notifications')
	config.add_route('ajax_set_user_receive_mails',                 'ajax_set_user_receive_mails')
