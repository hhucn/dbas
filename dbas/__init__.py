...
def main(global_config, **settings):
    ...
    config.add_route('ajax_revoke_statement_content', '{url:.*}ajax_revoke_statement_content')
    config.add_route('ajax_revoke_argument_content', '{url:.*}ajax_revoke_argument_content')
