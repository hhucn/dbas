...
def setup_discussion_database(session, user):
	...
	import datetime
	textversion1.timestamp = datetime.date(2016, 1, 4)
	textversion2.timestamp = datetime.date(2016, 1, 4)
	textversion3.timestamp = datetime.date(2016, 1, 4)
	textversion4.timestamp = datetime.date(2016, 1, 4)
	textversion5.timestamp = datetime.date(2016, 2, 4)
	textversion6.timestamp = datetime.date(2016, 2, 4)
	textversion7.timestamp = datetime.date(2016, 2, 4)
	textversion8.timestamp = datetime.date(2016, 2, 4)
	textversion9.timestamp = datetime.date(2016, 2, 4)
	textversion10.timestamp = datetime.date(2016, 3, 4)
	textversion11.timestamp = datetime.date(2016, 3, 4)
	textversion12.timestamp = datetime.date(2016, 1, 4)
	textversion13.timestamp = datetime.date(2016, 1, 4)
	textversion14.timestamp = datetime.date(2016, 7, 4)
	textversion15.timestamp = datetime.date(2016, 7, 4)
	textversion16.timestamp = datetime.date(2016, 7, 4)
	textversion17.timestamp = datetime.date(2016, 7, 4)
	textversion18.timestamp = datetime.date(2016, 7, 4)
	textversion19.timestamp = datetime.date(2016, 7, 4)
	textversion20.timestamp = datetime.date(2016, 7, 4)
	textversion21.timestamp = datetime.date(2016, 8, 4)
	textversion22.timestamp = datetime.date(2016, 8, 4)
	textversion23.timestamp = datetime.date(2016, 8, 4)
	textversion24.timestamp = datetime.date(2016, 8, 4)
	textversion25.timestamp = datetime.date(2016, 8, 4)
	textversion26.timestamp = datetime.date(2016, 8, 4)
	textversion27.timestamp = datetime.date(2016, 8, 4)
	textversion29.timestamp = datetime.date(2016, 8, 4)
	textversion30.timestamp = datetime.date(2016, 8, 4)
	textversion31.timestamp = datetime.date(2016, 8, 4)
	textversion32.timestamp = datetime.date(2016, 10, 4)
	textversion33.timestamp = datetime.date(2016, 10, 4)
	textversion34.timestamp = datetime.date(2016, 10, 4)
	textversion35.timestamp = datetime.date(2016, 10, 4)
	textversion36.timestamp = datetime.date(2016, 10, 4)
	textversion101.timestamp = datetime.date(2016, 11, 4)
	textversion102.timestamp = datetime.date(2016, 11, 4)
	textversion103.timestamp = datetime.date(2016, 11, 4)
	textversion105.timestamp = datetime.date(2016, 12, 4)
	textversion106.timestamp = datetime.date(2016, 12, 4)
	textversion107.timestamp = datetime.date(2016, 12, 4)
	textversion108.timestamp = datetime.date(2016, 12, 4)
	textversion109.timestamp = datetime.date(2016, 12, 4)
	textversion110.timestamp = datetime.date(2016, 12, 4)
	textversion111.timestamp = datetime.date(2016, 12, 4)
	textversion112.timestamp = datetime.date(2016, 17, 4)
	textversion113.timestamp = datetime.date(2016, 17, 4)
	textversion114.timestamp = datetime.date(2016, 17, 4)
	textversion115.timestamp = datetime.date(2016, 17, 4)
	textversion116.timestamp = datetime.date(2016, 17, 4)
	textversion117.timestamp = datetime.date(2016, 17, 4)
	textversion118.timestamp = datetime.date(2016, 17, 4)
	textversion119.timestamp = datetime.date(2016, 17, 4)
	textversion120.timestamp = datetime.date(2016, 17, 4)
	textversion121.timestamp = datetime.date(2016, 17, 4)
	textversion122.timestamp = datetime.date(2016, 18, 4)
	textversion123.timestamp = datetime.date(2016, 18, 4)
	textversion200.timestamp = datetime.date(2016, 18, 4)
	textversion201.timestamp = datetime.date(2016, 18, 4)
	textversion202.timestamp = datetime.date(2016, 18, 4)
	textversion203.timestamp = datetime.date(2016, 20, 4)
	textversion204.timestamp = datetime.date(2016, 20, 4)
	textversion205.timestamp = datetime.date(2016, 20, 4)
	textversion206.timestamp = datetime.date(2016, 20, 4)
	textversion207.timestamp = datetime.date(2016, 20, 4)
	textversion208.timestamp = datetime.date(2016, 20, 4)
	textversion209.timestamp = datetime.date(2016, 20, 4)
	textversion210.timestamp = datetime.date(2016, 20, 4)
	textversion211.timestamp = datetime.date(2016, 20, 4)
