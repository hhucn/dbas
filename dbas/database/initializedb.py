...
def setup_review_database(session):
    ...
    reviewer08 = LastReviewerOptimization(random.randint(int_start, int_end), review02.uid, False)
    reviewer09 = LastReviewerDelete(random.randint(int_start, int_end), review06.uid, True)
    reviewer10 = LastReviewerDelete(random.randint(int_start, int_end), review06.uid, False)
    reviewer11 = LastReviewerDelete(random.randint(int_start, int_end), review06.uid, True)
    reviewer12 = LastReviewerDelete(random.randint(int_start, int_end), review06.uid, True)
    reviewer13 = LastReviewerDelete(random.randint(int_start, int_end), review06.uid, True)
    ...
    reviewer16 = LastReviewerDelete(random.randint(int_start, int_end), review07.uid, True)
