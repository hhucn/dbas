...
def setup_up_users(session):
	...
	pw4 = PasswordHandler.get_hashed_password('michael')
...
def setup_discussion_database(session, user):
	...
	issue5 = Issue(title='Maßnahmen zur Unterstützung der Sekretariate', info='Unsere Sekretariate in der Informatik sind arbeitsmäßig stark überlastet. Bitte diskutieren Sie Maßnahmen zur Unterstützung der Sekretariate.', author_uid=user.uid, lang_uid=lang2.uid)
