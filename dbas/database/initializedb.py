...
def setup_review_database(session):
    ...
    history19 = ReputationHistory(reputator=christian.uid, reputation=reputation08.uid, timestamp=today)
    history10 = ReputationHistory(reputator=christian.uid, reputation=reputation09.uid, timestamp=today)
    ...
    history14 = ReputationHistory(reputator=tobias.uid, reputation=reputation07.uid, timestamp=yesterday)
    history15 = ReputationHistory(reputator=tobias.uid, reputation=reputation08.uid, timestamp=today)
    history16 = ReputationHistory(reputator=tobias.uid, reputation=reputation09.uid, timestamp=today)
