...
def main_discussion(argv=sys.argv):
    ...
    with transaction.manager:
        user0, user1, user2, user3, user4, user5, user6, user7, user8, user9, usert00, usert01, usert02, usert03, usert04, usert05, usert06, usert07, usert08, usert09, usert10, usert11, usert12, usert13, usert14, usert15, usert16, usert17, usert18, usert19, usert20, usert21, usert22, usert23, usert24, usert25, usert26, usert27, usert28, usert29, usert30 = set_up_users(DBDiscussionSession)
        ...
        set_up_settings(DBDiscussionSession, user0, user1, user2, user3, user4, user5, user6, user7, user8, user9, usert00, usert01, usert02, usert03, usert04, usert05, usert06, usert07, usert08, usert09, usert10, usert11, usert12, usert13, usert14, usert15, usert16, usert17, usert18, usert19, usert20, usert21, usert22, usert23, usert24, usert25, usert26, usert27, usert28, usert29, usert30)
...
def set_up_users(session):
    ...
    user5 = User(firstname='Raphael', surname='Bialon', nickname='Яaphael', email='bialon@cs.uni-duesseldorf.de', password=pw5, group_uid=group1.uid, gender='m')
    user6 = User(firstname='Alexander', surname='Schneider', nickname='WeGi', email='aschneider@cs.uni-duesseldorf.de', password=pw6, group_uid=group1.uid, gender='m')
    user7 = User(firstname='Katharina', surname='Esau', nickname='katesa', email='katharina.esau@hhu.de', password=pw7, group_uid=group1.uid, gender='f')
    user8 = User(firstname='Björn', surname='Ebbinghaus', nickname='Björn', email='bjoern.ebbinghaus@uni-duesseldorf.de', password=pw8, group_uid=group0.uid, gender='m')
    user9 = User(firstname='Teresa', surname='Uebber', nickname='Teresa', email='teresa.uebber@uni-duesseldorf.de', password=pw9, group_uid=group0.uid, gender='f')

    usert00 = User(firstname='Pascal', surname='Lux', nickname='Pascal', email='.tobias.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert01 = User(firstname='Kurt', surname='Hecht', nickname='Kurt', email='t.obias.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert02 = User(firstname='Torben', surname='Hartl', nickname='Torben', email='to.bias.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert03 = User(firstname='Thorsten', surname='Scherer', nickname='Thorsten', email='tob.ias.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert04 = User(firstname='Friedrich', surname='Schutte', nickname='Friedrich', email='tobi.as.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert05 = User(firstname='Aayden', surname='Westermann', nickname='Aayden', email='tobia.s.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert06 = User(firstname='Hermann', surname='Grasshoff', nickname='Hermann', email='tobias.krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert07 = User(firstname='Wolf', surname='Himmler', nickname='Wolf', email='tobias..krauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert08 = User(firstname='Jakob', surname='Winter', nickname='Jakob', email='tobias.k.rauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert09 = User(firstname='Alwin', surname='Wechter', nickname='Alwin', email='tobias.kr.authoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert10 = User(firstname='Walter', surname='Weisser', nickname='Walter', email='tobias.kra.uthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert11 = User(firstname='Volker', surname='Keitel', nickname='Volker', email='tobias.krau.thoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert12 = User(firstname='Benedikt', surname='Feuerstein', nickname='Benedikt', email='tobias.kraut.hoff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert13 = User(firstname='Engelbert', surname='Gottlieb', nickname='Engelbert', email='tobias.krauth.off@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert14 = User(firstname='Elias', surname='Auerbach', nickname='Elias', email='tobias.krautho.ff@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert15 = User(firstname='Rupert', surname='Wenz', nickname='Rupert', email='tobias.krauthof.f@gmail.com', password=pwt, group_uid=group2.uid, gender='m')
    usert16 = User(firstname='Marga', surname='Wegscheider', nickname='Marga', email='t.obias.krautho.ff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert17 = User(firstname='Larissa', surname='Clauberg', nickname='Larissa', email='to.bias.krauth.off@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert18 = User(firstname='Emmi', surname='Rosch', nickname='Emmi', email='tob.ias.kraut.hoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert19 = User(firstname='Konstanze', surname='Krebs', nickname='Konstanze', email='tobi.as.krau.thoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert20 = User(firstname='Catrin', surname='Fahnrich', nickname='Catrin', email='tobia.s.kra.uthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert21 = User(firstname='Antonia', surname='Bartram', nickname='Antonia', email='tobias..kr.authoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert22 = User(firstname='Nora', surname='Kempf', nickname='Nora', email='tobias..k.rauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert23 = User(firstname='Julia', surname='Wetter', nickname='Julia', email='tobias.k..rauthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert24 = User(firstname='Jutta', surname='Munch', nickname='Jutta', email='tobias.kr..authoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert25 = User(firstname='Helga', surname='Heilmann', nickname='Helga', email='tobias..kra.uthoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert26 = User(firstname='Denise', surname='Tietjen', nickname='Denise', email='tobia.s.krau.thoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert27 = User(firstname='Hanne', surname='Beckmann', nickname='Hanne', email='tobi.as.kraut.hoff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert28 = User(firstname='Elly', surname='Landauer', nickname='Elly', email='tob.ias.krauth.off@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert29 = User(firstname='Sybille', surname='Redlich', nickname='Sybille', email='to.bias.krautho.ff@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
    usert30 = User(firstname='Ingeburg', surname='Fischer', nickname='Ingeburg', email='t.obias.krauthof.f@gmail.com', password=pwt, group_uid=group2.uid, gender='f')
