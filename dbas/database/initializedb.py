...
def __setup_fieltests_de_discussion_database(session, db_issue):
    ...
    statement9 = Statement(textversion=textversion9.uid, is_position=False, issue=db_issue.uid)
...
def __setup_review_dummy_database(session):
    ...
    value01 = ReviewMergeValues(review=review20.uid, content='lorem ipsum dolorem sit value01')
    value02 = ReviewMergeValues(review=review21.uid, content='lorem ipsum dolorem sit value02')
    value03 = ReviewSplitValues(review=review22.uid, content='lorem ipsum dolorem sit value03')
    value04 = ReviewSplitValues(review=review22.uid, content='lorem ipsum dolorem sit value04')
    value05 = ReviewSplitValues(review=review22.uid, content='lorem ipsum dolorem sit value05')
    value06 = ReviewSplitValues(review=review23.uid, content='lorem ipsum dolorem sit value06')
    value07 = ReviewSplitValues(review=review23.uid, content='lorem ipsum dolorem sit value07')
    value08 = ReviewSplitValues(review=review23.uid, content='lorem ipsum dolorem sit value08')
    value09 = ReviewSplitValues(review=review23.uid, content='lorem ipsum dolorem sit value09')
    value10 = ReviewSplitValues(review=review23.uid, content='lorem ipsum dolorem sit value10')
