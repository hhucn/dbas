...
def main(argv=sys.argv):
	...
	with transaction.manager:
		...
		argument0 = Argument(premissegroup=premissegroup1.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement1.uid)
		argument1 = Argument(premissegroup=premissegroup2.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement1.uid)
		argument2 = Argument(premissegroup=premissegroup3.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement2.uid)
		argument3 = Argument(premissegroup=premissegroup4.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement2.uid)
		argument4 = Argument(premissegroup=premissegroup5.uid, issupportive=False, author=user2.uid, weight=0)
		argument5 = Argument(premissegroup=premissegroup6.uid, issupportive=False, author=user2.uid, weight=0)
		argument6 = Argument(premissegroup=premissegroup7.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement3.uid)
		argument7 = Argument(premissegroup=premissegroup8.uid, issupportive=False, author=user2.uid, weight=0)
		argument8 = Argument(premissegroup=premissegroup9.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement10.uid)
		argument9 = Argument(premissegroup=premissegroup10.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement1.uid)
		argument10 = Argument(premissegroup=premissegroup11.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement1.uid)
		argument11 = Argument(premissegroup=premissegroup12.uid, issupportive=False, author=user2.uid, weight=0)
		argument12 = Argument(premissegroup=premissegroup13.uid, issupportive=False, author=user2.uid, weight=0)
		argument13 = Argument(premissegroup=premissegroup14.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement4.uid)
		argument14 = Argument(premissegroup=premissegroup15.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement4.uid)
		argument15 = Argument(premissegroup=premissegroup16.uid, issupportive=True, author=user2.uid, weight=0)
		argument16 = Argument(premissegroup=premissegroup17.uid, issupportive=False, author=user2.uid, weight=0)
		argument17 = Argument(premissegroup=premissegroup18.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement5.uid)
		argument18 = Argument(premissegroup=premissegroup19.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement5.uid)
		argument19 = Argument(premissegroup=premissegroup20.uid, issupportive=True, author=user2.uid, weight=0)
		argument20 = Argument(premissegroup=premissegroup21.uid, issupportive=False, author=user2.uid, weight=0)
		argument21 = Argument(premissegroup=premissegroup22.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement13.uid)
		argument22 = Argument(premissegroup=premissegroup23.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement13.uid)
		argument23 = Argument(premissegroup=premissegroup24.uid, issupportive=False, author=user2.uid, weight=0)
		argument24 = Argument(premissegroup=premissegroup25.uid, issupportive=True, author=user2.uid, weight=0)
		argument25 = Argument(premissegroup=premissegroup26.uid, issupportive=True, author=user2.uid, weight=0)
		argument26 = Argument(premissegroup=premissegroup27.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement14.uid)
		argument27 = Argument(premissegroup=premissegroup27.uid, issupportive=True, author=user2.uid, weight=0, conclusion=statement15.uid)
		# IMPORTANT: If the conclusion is an argument, check the counter!
		argument28 = Argument(premissegroup=premissegroup28.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement14.uid)
		argument29 = Argument(premissegroup=premissegroup28.uid, issupportive=False, author=user2.uid, weight=0, conclusion=statement15.uid)
		# IMPORTANT: If the conclusion is an argument, check the counter!
		DBSession.add_all([argument0,argument1,argument2,argument3,argument4,argument5,argument6,argument7,argument8,argument9,argument10,argument11,argument12,argument13,argument14,argument15,argument16,argument17,argument18,argument19,argument20,argument21,argument22,argument23,argument24,argument25,argument26,argument27,argument28,argument29])
		DBSession.flush()
