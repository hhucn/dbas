...
class UserHandlerTests(TestCaseWithConfig):
    ...
    def test_get_reviews_of(self):
        ...
        rv = ReviewEdit(self.user_tobi, self.first_argument, self.first_position_cat_or_dog)
    ...
    def test_get_count_of_clicks(self):
        ...
        DBDiscussionSession.add(ClickedStatement(self.first_position_cat_or_dog, self.user_tobi))
