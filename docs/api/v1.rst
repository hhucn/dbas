...
.. note::
   If you want to modify the swagger document, consider using official tools, which support you, e.g. the
   swagger-editor. You can start an interactive editor with this command::

    docker run -p 8080:8080 swaggerapi/swagger-editor

   and then open http://localhost:8080 to access the editor. Load the yaml definition and start editing it.
