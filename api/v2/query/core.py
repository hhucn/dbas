...
class IssueGraph(SQLAlchemyObjectType):
    ...
    def resolve_number_of_participating_authors(self: Issue, info):
        return len(self.participating_authors)

    def resolve_number_of_participants(self: Issue, info):
        return len(self.participating_authors)
